...
# Calculate mean and median values by sub-region
...
mean_internet_stats <- df %>%
  group_by(sub_region) %>%
  summarise(
    mean_users_per_km2 = mean(int_users_per_km2, na.rm = TRUE),
    mean_percent_users = mean(percent_internet_users, na.rm = TRUE)
  )
...
annotation5 = "population, i.e. 3.7 billion people"
annotation6 = "living in poor countries in the Global South,"
...
p <- ggplot(median_internet_stats, aes(x = median_users_per_km2, y = reorder(sub_region, median_users_per_km2), 
  ...
  annotate("text", x = 46.5, y = 7, label = annotation4, size=4.5, color = "black",family="Nunito",hjust=0.1)+
  annotate("text", x = 44, y = 6, label = annotation5, size=4.5, color = "black",family="Nunito",hjust=0.1)+
  annotate("text", x = 46, y = 5, label = annotation6, size=4.5, color = "black",family="Nunito",hjust=0.1)+
  annotate("text", x = 43, y = 4, label = annotation7, size=4.5, color = "black",family="Nunito",hjust=0.1)+
  theme_minimal() +
...
p2 <- ggplot(mean_internet_stats, aes(x = mean_users_per_km2, y = reorder(sub_region, mean_users_per_km2), 
  ...
  annotate("text", x = 102, y = 7, label = annotation4, size=4.5, color = "black",family="Nunito",hjust=0.1)+
  annotate("text", x = 94, y = 6, label = annotation5, size=4.5, color = "black",family="Nunito",hjust=0.1)+
